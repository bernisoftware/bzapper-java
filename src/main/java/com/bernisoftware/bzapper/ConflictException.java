...
/**
 * HTTP 409 — conflicting state (e.g. {@code idempotency_in_progress}, campaign already started, event already owned by another webhook).
 *
 * <p>Extends {@link BzapperException}: branch on {@link #getCode()}.
 */
public class ConflictException extends BzapperException {
     ...
     */
    public ConflictException(String code, String message, int statusCode, String locale, String requestId,
